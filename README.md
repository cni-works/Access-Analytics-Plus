...
Current release: `0.5.7-beta` / Build `beta.20260912.5`
...
Build `beta.20260912.5` では、日本国内のconfirmedアクセスを都道府県別に確認できます。国判定後にJPだけをDB-IP City Lite由来の軽量な派生MMDBで照合し、期間内の一意な訪問者を、その期間で最初に確認されたセッションの都道府県へ割り当てます。携帯回線・VPN等では推定位置が実際と異なる場合があります。
